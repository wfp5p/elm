static char rcsid[] = "@(#)$Id: read_rc.c,v 1.11 1999/03/24 14:04:03 wfp5p Exp $";
...
int matchInList(list,count,buffer,ignoreCase)
char *list[];
int count;
char *buffer;
int ignoreCase;
